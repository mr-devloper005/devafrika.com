export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'devafrika',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Devafrika',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'devafrika.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://devafrika.com',
