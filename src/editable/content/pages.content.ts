...
export const pagesContent = {
  home: {
    ...
    hero: {
      badge: 'Listings & classifieds — Africa-wide',
      title: ['Buy, sell, and discover', 'businesses near you.'],
      description: 'Post a listing, browse classifieds, or find trusted businesses and services near you — Africa\'s local marketplace, all in one place.',
      primaryCta: { label: 'Browse listings', href: '/listing' },
      secondaryCta: { label: 'View classifieds', href: '/classified' },
      searchPlaceholder: 'Search listings, classifieds, and businesses',
      focusLabel: 'Focus',
